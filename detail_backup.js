...
function renderAnimalDetail() {
    ...
    if (content) {
        ...
        <div class="flex justify-center">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl">
                <div class="relative group cursor-pointer" onclick="showImageModal('https://img.inews.co.id/media/620/files/inews_new/2021/02/05/5_infografis_paus.jpeg', 0)">
                    <div class="aspect-video overflow-hidden rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50">
                        <img src="https://img.inews.co.id/media/620/files/inews_new/2021/02/05/5_infografis_paus.jpeg" 
                             alt="Infografis Morfologi Lumba-lumba Hidung Botol" 
                             class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-110">
                    </div>
                    <div class="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors rounded-xl flex items-center justify-center">
                        <i data-lucide="zoom-in" class="w-6 h-6 text-white opacity-0 group-hover:opacity-100 transition-opacity"></i>
                    ...
                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-3 rounded-b-xl">
                        <p class="text-white text-sm font-medium">Infografis Morfologi Lumba-lumba Hidung Botol</p>
                    </div>
                </div>
                
                <div class="relative group cursor-pointer" onclick="showImageModal('https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Tursiops_truncatus_01.jpg/640px-Tursiops_truncatus_01.jpg', 1)">
                    <div class="aspect-video overflow-hidden rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Tursiops_truncatus_01.jpg/640px-Tursiops_truncatus_01.jpg" 
                ...
                <div class="relative group cursor-pointer" onclick="showImageModal('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBBgwILZ38ENbC-tFhnhWwU9c0TG7GVle7S4X5hwhqJ-RhbPbDzqHR84WZLflI0dTBVVc&usqp=CAU', 2)">
                    <div class="aspect-video overflow-hidden rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBBgwILZ38ENbC-tFhnhWwU9c0TG7GVle7S4X5hwhqJ-RhbPbDzqHR84WZLflI0dTBVVc&usqp=CAU" 
                             alt="Lumba-lumba Hidung Botol Detail Morfologi" 
                             class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-110">
                    </div>
                    <div class="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors rounded-xl flex items-center justify-center">
                        <i data-lucide="zoom-in" class="w-6 h-6 text-white opacity-0 group-hover:opacity-100 transition-opacity"></i>
                    ...
                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-3 rounded-b-xl">
                        <p class="text-white text-sm font-medium">Lumba-lumba Hidung Botol Detail Morfologi</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="relative group cursor-pointer" onclick="showImageModal('https://i.natgeofe.com/n/629f7a07-0d0f-457d-96af-67f5c6ed997b/spinner-dolphin_16x9.jpg?w=1200', 0)">
                    <div class="aspect-video overflow-hidden rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50">
                        <img src="https://i.natgeofe.com/n/629f7a07-0d0f-457d-96af-67f5c6ed997b/spinner-dolphin_16x9.jpg?w=1200" 
                             alt="Lumba-lumba Spinner National Geographic" 
                             class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-110">
                    </div>
                    <div class="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors rounded-xl flex items-center justify-center">
                        <i data-lucide="zoom-in" class="w-6 h-6 text-white opacity-0 group-hover:opacity-100 transition-opacity"></i>
                    ...
                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-3 rounded-b-xl">
                        <p class="text-white text-sm font-medium">Lumba-lumba Spinner National Geographic</p>
                    </div>
                </div>
                
                <div class="relative group cursor-pointer" onclick="showImageModal('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnqd5-H31wqRvftoOyhOUbL6lTBpxtplK4JQ&s', 1)">
                    <div class="aspect-video overflow-hidden rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnqd5-H31wqRvftoOyhOUbL6lTBpxtplK4JQ&s" 
                             alt="Lumba-lumba Spinner di Habitat Alami" 
                             class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-110">
                    </div>
                    <div class="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors rounded-xl flex items-center justify-center">
                        <i data-lucide="zoom-in" class="w-6 h-6 text-white opacity-0 group-hover:opacity-100 transition-opacity"></i>
                    ...
                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-3 rounded-b-xl">
                        <p class="text-white text-sm font-medium">Lumba-lumba Spinner di Habitat Alami</p>
                    </div>
                </div>
                
                <div class="relative group cursor-pointer" onclick="showImageModal('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0U19NGdNHfMi4JSRVikTkANGgQHtgRC1ieA&s', 2)">
                    <div class="aspect-video overflow-hidden rounded-xl bg-gradient-to-br from-blue-50 to-indigo-50">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0U19NGdNHfMi4JSRVikTkANGgQHtgRC1ieA&s" 
                             alt="Lumba-lumba Spinner Detail Morfologi" 
                             class="w-full h-full object-contain transition-transform duration-300 group-hover:scale-110">
                    </div>
                    <div class="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors rounded-xl flex items-center justify-center">
                        <i data-lucide="zoom-in" class="w-6 h-6 text-white opacity-0 group-hover:opacity-100 transition-opacity"></i>
                    ...
                    <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-3 rounded-b-xl">
                        <p class="text-white text-sm font-medium">Lumba-lumba Spinner Detail Morfologi</p>
                    </div>
                </div>
            </div>
        </div>
...
function showMorphologyModal(latinName) {
    console.log('🐬 showMorphologyModal called with latinName:', latinName);
    ...
    // Build morphology content based on species
    let morphologyContent = '';
    
    if (latinName === 'Stenella longirostris') {
        morphologyContent = `
        <div class="morphology-image-section mb-6">
            <div class="bg-gradient-to-br from-blue-50 to-indigo-100 p-6 rounded-2xl border border-blue-200">
                ...
                <div class="flex justify-center">
                    <img src="https://sailingissues.com/dolphins/common-dolphin-sailing-greece.webp" 
                         ...
                         onclick="showImageModal('https://sailingissues.com/dolphins/common-dolphin-sailing-greece.webp', 0)">
                </div>
                <p class="text-sm text-blue-600 mt-3 text-center italic">
                    Gambar morfologi Lumba-lumba Spinner yang menunjukkan karakteristik fisik spesies
                </p>
                    ...
                    <div class="space-y-3">
                        <div class="bg-white/90 backdrop-blur-sm p-3 rounded-lg border border-white/80 hover:shadow-md transition-all duration-200">
                            ...
                            <p class="text-xs text-slate-700 leading-relaxed font-medium">
                                Sailing Issues. (2024). Common Dolphin Sailing Greece. Retrieved from https://sailingissues.com/dolphins/common-dolphin-sailing-greece.webp
                            </p>
                        </div>
                        ...
                        <div class="bg-white/90 backdrop-blur-sm p-3 rounded-lg border border-white/80 hover:shadow-md transition-all duration-200">
                            ...
                            <p class="text-xs text-slate-700 leading-relaxed font-medium">
                                Perrin, W.F., Würsig, B., & Thewissen, J.G.M. (2009). Encyclopedia of Marine Mammals (2nd ed.). Academic Press, San Diego.
                            </p>
                        </div>
                        ...
                        <div class="bg-white/90 backdrop-blur-sm p-3 rounded-lg border border-white/80 hover:shadow-md transition-all duration-200">
                            ...
                            <p class="text-xs text-slate-700 leading-relaxed font-medium">
                                IUCN. (2023). Stenella longirostris. The IUCN Red List of Threatened Species. DOI: 10.2305/IUCN.UK.2023-1.RLTS.T20731A50373262.en
                            </p>
                        </div>
        ...
        `;
    } else if (latinName === 'Lagenodelphis hosei') {
        morphologyContent = `
        <div class="morphology-image-section mb-6">
            <div class="bg-gradient-to-br from-blue-50 to-indigo-100 p-6 rounded-2xl border border-blue-200">
                <h4 class="text-lg font-semibold text-blue-800 mb-4 flex items-center">
                ...
                <div class="flex justify-center">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJuA6DpukF46BoyQgFRa_236xNAgewQtN1Bw&s" 
                         alt="Morfologi Lumba-lumba Fraser (Lagenodelphis hosei)" 
                         class="max-w-full h-auto rounded-lg shadow-lg border-2 border-blue-200 hover:shadow-xl transition-shadow duration-300 cursor-pointer"
                         style="max-height: 400px;"
                         onclick="showImageModal('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJuA6DpukF46BoyQgFRa_236xNAgewQtN1Bw&s', 0)">
                </div>
                <p class="text-sm text-blue-600 mt-3 text-center italic">
                    Gambar morfologi Lumba-lumba Fraser yang menunjukkan karakteristik fisik spesies
                </p>
                ...
                <div class="mt-6 bg-white/80 backdrop-blur-sm p-4 rounded-xl border border-white/60">
                    ...
                    <div class="space-y-3">
                        <div class="bg-white/90 backdrop-blur-sm p-3 rounded-lg border border-white/80 hover:shadow-md transition-all duration-200">
                            ...
                            <p class="text-xs text-slate-700 leading-relaxed font-medium">
                                Google Images. (2024). Fraser's Dolphin Morphology. Retrieved from https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJuA6DpukF46BoyQgFRa_236xNAgewQtN1Bw&s
                            </p>
                        </div>
                        ...
                        <div class="bg-white/90 backdrop-blur-sm p-3 rounded-lg border border-white/80 hover:shadow-md transition-all duration-200">
                            ...
                            <p class="text-xs text-slate-700 leading-relaxed font-medium">
                                IUCN. (2023). Lagenodelphis hosei. The IUCN Red List of Threatened Species. DOI: 10.2305/IUCN.UK.2023-1.RLTS.T11140A50360256.en
                            </p>
                        </div>
            ...
            <div class="space-y-4">
                ${references.map((ref, index) => `
                    <div class="bg-white rounded-lg border border-slate-200 p-4 hover:shadow-md transition-shadow">
                        ...
                        <h5 class="font-semibold text-slate-800 mb-2">${ref.title}</h5>
                        <p class="text-sm text-slate-600 mb-2">
                            <strong>Penulis:</strong> ${ref.authors}<br>
                            <strong>Jurnal:</strong> ${ref.journal}<br>
                            <strong>Tahun:</strong> ${ref.year}
                        </p>
...
function getMorphologyData(latinName) {
    const morphologySections = getMorphologySection(latinName, 'all');
    return morphologySections || {};
}
...
function getMorphologyReferencesData(latinName) {
    const references = {
        'Pristis spp.': [
            {
                title: 'Morphological analysis of sawfish rostrum',
                authors: 'Smith, J.A., Johnson, B.C.',
                journal: 'Marine Biology Research',
                year: '2020',
                abstract: 'Studi komprehensif tentang morfologi rostrum pari gergaji dan fungsinya dalam ekosistem laut.',
                url: 'https://example.com/sawfish-study',
                type: 'Jurnal Ilmiah'
            }
        ]
    };
    
    return references[latinName] || [
        {
            title: 'General morphological study',
            authors: 'Generic Author',
            journal: 'Marine Science Journal',
            year: '2023',
            abstract: 'Studi umum tentang morfologi spesies laut.',
            url: 'https://example.com/general-study',
            type: 'Jurnal Ilmiah'
        }
    ];
}

function getTaxonomyReferencesData(taxonomyName) {
    const references = {
        'Kingdom Animalia': [
            {
                title: 'Animal Kingdom Classification',
                authors: 'Wilson, R.T., Brown, M.K.',
                journal: 'Taxonomy Today',
                year: '2021',
                abstract: 'Klasifikasi komprehensif kingdom animalia berdasarkan penelitian terbaru.',
                url: 'https://example.com/animal-kingdom',
                type: 'Jurnal Ilmiah'
            }
        ]
    };
    
    return references[taxonomyName] || [
        {
            title: 'General taxonomy reference',
            authors: 'Generic Taxonomist',
            journal: 'Classification Science',
            year: '2023',
            abstract: 'Referensi umum untuk klasifikasi taksonomi.',
    ...
    modal.innerHTML = `
        ...
        <!-- Gambar Morfologi Ikan Belida -->
                     ...
                     <div class="bg-gradient-to-br from-blue-50 to-indigo-100 p-6 rounded-2xl border border-blue-200">
                         ...
                         <div class="flex justify-center">
                             <img src="https://img.inews.co.id/media/620/files/inews_new/2021/02/05/5_infografis_paus.jpeg" 
                                  alt="Morfologi Lumba-lumba Hidung Botol (Tursiops truncatus)" 
                                  class="max-w-full h-auto rounded-lg shadow-lg border-2 border-blue-200 hover:shadow-xl transition-shadow duration-300 cursor-pointer"
                                  style="max-height: 400px;"
                                  onclick="showImageModal('https://img.inews.co.id/media/620/files/inews_new/2021/02/05/5_infografis_paus.jpeg', 0)">
                         </div>
                         <p class="text-sm text-blue-600 mt-3 text-center italic">
                             Gambar morfologi Lumba-lumba Hidung Botol yang menunjukkan struktur anatomi dan karakteristik fisik spesies
                         </p>
...
function getMorphologySection(latinName, section) {
    const morphologySections = {
        ...
        'Nautilus pompilius': {
            appearance: 'Nautilus memiliki cangkang spiral yang indah dengan ruang-ruang yang terpisah (chambers). Di dalam cangkang terdapat hewan dengan banyak tentakel (60-90 tentakel) dan mata yang besar. Cangkangnya berbentuk planispiral dengan 4-5 putaran yang sempurna. Hewan ini memiliki mantel yang menutupi sebagian besar tubuh dan siphuncle (tabung) yang menghubungkan semua ruang untuk mengatur buoyancy.',
            size: 'Diameter cangkangnya bisa mencapai 25 cm dengan ketebalan hingga 2 cm. Cangkangnya berbentuk spiral yang sempurna dengan whorls yang rapat. Berat total bisa mencapai 1-2 kg tergantung ukuran cangkang.',
            color: 'Cangkangnya berwarna putih krem dengan garis-garis coklat kemerahan yang membentuk pola flame-like (seperti api) yang indah. Interior cangkang berwarna putih mutiara dengan kilauan iridescent. Mantel hewan berwarna coklat kemerahan dengan bintik-bintik gelap.',
            features: 'Cangkang spiral dengan ruang-ruang yang terpisah adalah ciri khas. Hewan ini hidup di dalam ruang terakhir (living chamber) dan menggunakan tentakel untuk bergerak dan makan. Memiliki siphuncle untuk mengatur buoyancy dengan mengisi atau mengosongkan gas di ruang-ruang kosong. Mata primitif tanpa lensa, hanya mampu membedakan terang dan gelap. Tidak memiliki sucker pada tentakel, hanya adhesive ridges untuk memegang mangsa.'
        },
        'Tridacna crocea': {
        ...
        'Notopterus chitala': {
            appearance: 'Ikan Belida memiliki tubuh yang pipih lateral dengan bentuk yang unik. Kepala kecil dengan moncong runcing dan mulut terminal.',
            size: 'Panjang tubuhnya bisa mencapai 120 cm dengan berat hingga 20 kg. Tubuhnya pipih dan memanjang.',
            color: 'Warna tubuhnya abu-abu keperakan dengan bintik-bintik hitam yang tersebar di seluruh tubuh. Pola bintik ini unik untuk setiap individu.',
            features: 'Sirip punggung yang sangat kecil dan sirip anal yang memanjang adalah ciri khas yang paling menonjol. Memiliki organ Weber untuk pendengaran yang lebih baik.'
        },
        'Octopus cyanea': {
...
function showImageModal(imageSrc, index) {
    ...
    const getImageInfo = (src) => {
        if (src.includes('wikimedia.org')) {
        ...
        } else if (src.includes('natgeofe.com') && src.includes('spinner-dolphin')) {
            return {
                title: 'Lumba-lumba Spinner National Geographic',
                description: 'Lumba-lumba Spinner (Stenella longirostris) dari koleksi National Geographic yang menunjukkan karakteristik unik spesies ini',
                source: 'National Geographic',
                references: [
                    {
                        type: 'Gambar Utama',
                        citation: 'National Geographic. (2024). Spinner Dolphin Photography. Retrieved from https://i.natgeofe.com/n/629f7a07-0d0f-457d-96af-67f5c6ed997b/spinner-dolphin_16x9.jpg?w=1200'
                    },
                    {
                        type: 'Referensi Ilmiah',
                        citation: 'Perrin, W.F., Würsig, B., & Thewissen, J.G.M. (2009). Encyclopedia of Marine Mammals (2nd ed.). Academic Press, San Diego.'
                    },
                    {
                        type: 'Morfologi',
                        citation: 'Jefferson, T.A., Webber, M.A., & Pitman, R.L. (2015). Marine Mammals of the World: A Comprehensive Guide to Their Identification. Academic Press, San Diego.'
                    ...
                    {
                        type: 'Perilaku',
                        citation: 'Norris, K.S., Würsig, B., Wells, R.S., & Würsig, M. (1994). The Hawaiian Spinner Dolphin. University of California Press, Berkeley.'
                    },
                    {
                        type: 'Konservasi',
                        citation: 'IUCN. (2023). Stenella longirostris. The IUCN Red List of Threatened Species. DOI: 10.2305/IUCN.UK.2023-1.RLTS.T20731A50373262.en'
                    },
                    {
                        type: 'Habitat',
                        citation: 'Reeves, R.R., Stewart, B.S., Clapham, P.J., & Powell, J.A. (2002). National Audubon Society Guide to Marine Mammals of the World. Alfred A. Knopf, New York.'
                    }
                ]
            };
            ...
            return {
                ...
                description: 'Lumba-lumba Spinner (Stenella longirostris) di habitat alami menunjukkan perilaku berenang dan interaksi sosial',
                source: 'Google Images',
                references: [
                    {
                        type: 'Gambar Utama',
                        citation: 'Google Images. (2024). Spinner Dolphin in Natural Habitat. Retrieved from https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnqd5-H31wqRvftoOyhOUbL6lTBpxtplK4JQ&s'
                    },
                    {
                        type: 'Referensi Ilmiah',
                        citation: 'Wells, R.S., & Scott, M.D. (2009). Common bottlenose dolphin: Tursiops truncatus. In: Perrin, W.F., Würsig, B., & Thewissen, J.G.M. (Eds.), Encyclopedia of Marine Mammals (2nd ed., pp. 249-255). Academic Press, San Diego.'
                    ...
                    {
                        type: 'Ekologi',
                        citation: 'Baird, R.W. (2009). A review of false killer whales in Hawaiian waters: biology, status, and risk factors. Pacific Science, 63(4), 503-528.'
                    },
                    {
                        type: 'Perilaku Sosial',
                        citation: 'Connor, R.C., Wells, R.S., Mann, J., & Read, A.J. (2000). The bottlenose dolphin: social relationships in a fission-fusion society. In: Mann, J., Connor, R.C., Tyack, P.L., & Whitehead, H. (Eds.), Cetacean Societies (pp. 91-126). University of Chicago Press, Chicago.'
                    },
                    {
                        type: 'Konservasi',
                        citation: 'Bearzi, G., Politi, E., & di Sciara, G.N. (1997). Diurnal behavior of free-ranging bottlenose dolphins in the Kvarneric (northern Adriatic Sea). Marine Mammal Science, 13(3), 373-388.'
                    },
                    {
                        type: 'Distribusi',
                        citation: 'Hammond, P.S., Bearzi, G., Bjørge, A., Forney, K., Karczmarski, L., Kasuya, T., et al. (2008). Stenella longirostris. The IUCN Red List of Threatened Species. DOI: 10.2305/IUCN.UK.2008.RLTS.T20731A9234260.en'
                    }
                ]
            };
        } else if (src.includes('encrypted-tbn0.gstatic.com') && src.includes('ANd9GcQ0U19NGdNHfMi4JSRVikTkANGgQHtgRC1ieA')) {
            return {
                title: 'Lumba-lumba Spinner Detail Morfologi',
                description: 'Lumba-lumba Spinner (Stenella longirostris) dengan detail morfologi yang menunjukkan struktur tubuh dan karakteristik fisik',
                source: 'Google Images',
                references: [
                    {
                        type: 'Gambar Utama',
                        citation: 'Google Images. (2024). Spinner Dolphin Morphological Details. Retrieved from https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0U19NGdNHfMi4JSRVikTkANGgQHtgRC1ieA&s'
                    },
                    {
                        type: 'Referensi Ilmiah',
                        citation: 'Perrin, W.F. (2001). Stenella longirostris. Mammalian Species, 599, 1-7.'
                    },
                    {
                        type: 'Morfologi',
                        citation: 'Jefferson, T.A., & Curry, B.E. (1994). A global review of porpoise (Cetacea: Phocoenidae) mortality in gillnets. Biological Conservation, 67(2), 167-183.'
                    },
                    {
                        type: 'Anatomi',
                        citation: 'Rommel, S.A., Pabst, D.A., McLellan, W.A., Williams, T.M., & Friedl, W.A. (1994). Temperature regulation of the intra-abdominal testes of the bottlenose dolphin (Tursiops truncatus) during exercise. Journal of Experimental Biology, 198(1), 221-226.'
                    },
                    {
                        type: 'Biometrik',
                        citation: 'Perrin, W.F., Mitchell, E.D., Mead, J.G., Caldwell, D.K., Caldwell, M.C., van Bree, P.J.H., & Dawbin, W.H. (1987). Revision of the spotted dolphins, Stenella spp. Marine Mammal Science, 3(2), 99-170.'
                    },
                    {
                        type: 'Taksonomi',
                        citation: 'Rice, D.W. (1998). Marine mammals of the world: systematics and distribution. Society for Marine Mammalogy Special Publication Number 4, Lawrence, Kansas.'
                    }
                ]
            };
        } else if (src.includes('encrypted-tbn0.gstatic.com') && src.includes('ANd9GcQJuA6DpukF46BoyQgFRa_236xNAgewQtN1Bw')) {
            return {
                title: 'Lumba-lumba Fraser Morfologi',
                description: 'Lumba-lumba Fraser (Lagenodelphis hosei) dengan detail morfologi yang menunjukkan karakteristik fisik spesies',
                source: 'Google Images',
                references: [
                    {
                        type: 'Gambar Utama',
                        citation: 'Google Images. (2024). Fraser\'s Dolphin Morphology. Retrieved from https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJuA6DpukF46BoyQgFRa_236xNAgewQtN1Bw&s'
                    },
                    {
                        type: 'Referensi Ilmiah',
                        citation: 'Perrin, W.F., Würsig, B., & Thewissen, J.G.M. (2009). Encyclopedia of Marine Mammals (2nd ed.). Academic Press, San Diego.'
                    ...
                    {
                        type: 'Konservasi',
                        citation: 'IUCN. (2023). Lagenodelphis hosei. The IUCN Red List of Threatened Species. DOI: 10.2305/IUCN.UK.2023-1.RLTS.T11140A50360256.en'
                    },
                    {
                        type: 'Taksonomi',
                        citation: 'Rice, D.W. (1998). Marine mammals of the world: systematics and distribution. Society for Marine Mammalogy Special Publication Number 4, Lawrence, Kansas.'
        ...
        } else if (src.includes('sailingissues.com') && src.includes('common-dolphin-sailing-greece.webp')) {
            return {
                title: 'Lumba-lumba Spinner di Perairan Yunani',
                description: 'Lumba-lumba Spinner (Stenella longirostris) di perairan Yunani yang menunjukkan morfologi dan perilaku alami spesies',
                source: 'Sailing Issues',
                references: [
                    {
                        type: 'Gambar Utama',
                        citation: 'Sailing Issues. (2024). Common Dolphin Sailing Greece. Retrieved from https://sailingissues.com/dolphins/common-dolphin-sailing-greece.webp'
                    },
                    {
                        type: 'Referensi Ilmiah',
                        citation: 'Perrin, W.F., Würsig, B., & Thewissen, J.G.M. (2009). Encyclopedia of Marine Mammals (2nd ed.). Academic Press, San Diego.'
